"""Test script for schem parser."""

from schem_parser import SchemParser
import sys


def test_schem_parser(directory: str):
    """Test the schem parser on a directory.

    Args:
        directory: Path to directory with .schem files.
    """
    print("=" * 60)
    print("SCHEM PARSER TEST")
    print("=" * 60)
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python test_schem_parser.py <directory_with_schem_files>")
        sys.exit(1)

    test_schem_parser(sys.argv[1])